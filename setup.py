...
setuptools.setup(
    ...
    cmdclass=cmdclass,
    python_requires=">=3.9",
    install_requires=["numpy", "sounddevice", "pysoundfile", "requests", "wget", "vosk", "silero", "vbml", "rich"],
    setup_requires=["numpy", "sounddevice", "pysoundfile", "requests", "wget", "vosk", "silero", "vbml", "rich"]
)
